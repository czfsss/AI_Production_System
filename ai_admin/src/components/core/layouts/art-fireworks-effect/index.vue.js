...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.canvas, __VLS_intrinsicElements.canvas)({ ref: ("canvasRef"), ...{ class: ("layout-fireworks") }, });
    // @ts-ignore navigation for `const canvasRef = ref()`
    __VLS_ctx.canvasRef;
    __VLS_styleScopedClasses['layout-fireworks'];
    var __VLS_slots;
