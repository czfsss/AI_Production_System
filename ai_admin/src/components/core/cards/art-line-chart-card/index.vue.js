...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("line-chart-card art-custom-card") }, ...{ style: (({ height: `${__VLS_ctx.height}rem` })) }, });
    ...
    __VLS_ctx.chartRef;
    __VLS_styleScopedClasses['line-chart-card'];
