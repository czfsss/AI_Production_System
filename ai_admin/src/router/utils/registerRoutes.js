 ...
 * 转换路由组件配置
 */
function convertRouteComponent(route, iframeRoutes, depth = 0) {
 ...
 * 处理 iframe 类型路由
 */
function handleIframeRoute(targetRoute, sourceRoute, iframeRoutes, depth) {
 ...
 * 处理一级菜单路由
 */
function handleLayoutRoute(converted, route, component) {
 ...
 * 处理普通路由
 */
function handleNormalRoute(converted, component, routeName) {
    if (component) {
